...
namespace HeadHunter.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public void getInfosStack(string link_stack)
        {
            ...
            {
                stackReached = stackAnswersQuestionsReached[2].Replace("k", "000");
            }
            else
            {
        ...
        private MarketSales[] GetMarketSalesFromDatabaseStack(string Text)
        {
            ...
            {
                new MarketSales() { Market = stackMostTag.ToString(), Year = 2020, Count = Convert.ToInt32("0") },
                new MarketSales() { Market = "stackReputation", Year = 2020, Count = Convert.ToInt32(stackReputation) },
                new MarketSales() { Market = "stackAnswers", Year = 2020, Count = Convert.ToInt32(stackAnswers) },
                new MarketSales() { Market = "stackQuestions", Year = 2020, Count = Convert.ToInt32(stackQuestions) },
                new MarketSales() { Market = "stackReached", Year = 2020, Count = Convert.ToInt32(stackReached) },
        ...
        private MarketSales[] GetMarketSalesFromDatabase(string Text)
        {
            ...
            return new MarketSales[]
            {
                new MarketSales() { Market = "Repositories", Year = 2020, Count = Convert.ToInt32(githubRepositories) },
                new MarketSales() { Market = "Projects", Year = 2020, Count = Convert.ToInt32(githubProjects) },
                new MarketSales() { Market = "Stars", Year = 2020, Count = Convert.ToInt32(githubStars) },
                new MarketSales() { Market = "Followers", Year = 2020, Count = Convert.ToInt32(githubFollowers) },
                new MarketSales() { Market = "Following", Year = 2020, Count = Convert.ToInt32(githubFollowing) },
